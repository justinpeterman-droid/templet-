...
- **Why this phase matters** — the reasoning, so shortcuts are resisted.
- **Decisions / inputs** — choices to make before prompting Cursor.
- **Prompts for Cursor** — pasted one at a time.
